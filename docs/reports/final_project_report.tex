...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{docs/visuals/architecture_diagram.png}
\caption{End-to-end adversarial ML pipeline for intrusion detection. Solid arrows indicate the primary data flow; dashed arrows indicate adversarial sample generation during training and evaluation.}
